...
WELCOME_MESSAGE = (
    ...
    "Cuéntame con tus propias palabras quién eres, a qué te dedicas, "
    "cuánto ganas y qué préstamo necesitas. Te iré preguntando únicamente "
    "la información que haga falta."
)
